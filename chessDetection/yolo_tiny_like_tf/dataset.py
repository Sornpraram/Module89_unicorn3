...
from yolo_tiny_like_tf.utils import read_class_names, image_preprocess
# from yolo_tiny_like_tf.yolov3_tiny_model import bbox_iou
from yolo_tiny_like_tf.yolov4_tiny_model import bbox_iou
...
class Dataset(object):
    ...
    def __init__(self, dataset_type, TEST_INPUT_SIZE=TEST_INPUT_SIZE):
        ...
        self.num_batchs = int(np.ceil(self.num_samples / self.batch_size)) # np.ceil ปัดเลขลง
        self.batch_count = 0
