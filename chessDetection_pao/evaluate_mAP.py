...
from models.utils import load_yolo_weights, detect_image, image_preprocess, postprocess_boxes, nms, read_class_names
# from yolo_tiny_like_tf.utils import load_yolo_weights, detect_image, save_loss
...
def get_mAP(Yolo, dataset, score_threshold=0.25, iou_threshold=0.50, TEST_INPUT_SIZE=TEST_INPUT_SIZE):
    ...
    cprint("============= Ground Truth Explore ==============", "yellow")
    # ============================================== เก็บข้อมูลเป็น Ground Truth ===============================================
    ...
    for index in range(dataset.num_samples):
        ...
        # cprint(np.shape(pred_bbox), "green")
        t2 = time.time()
...
if __name__ == '__main__':       
    if YOLO_FRAMEWORK == "tf": # TensorFlow detection
        ...
        if YOLO_CUSTOM_WEIGHTS == False:
            ...
            yolo.load_weights("./checkpoints/yolov4_zhu_best_loss_10.17_epoch_6") # use custom weights
    ...
    testset = Dataset('test', TEST_INPUT_SIZE=INPUT_RESOLUTION)
    get_mAP(yolo, testset, score_threshold=0.55, iou_threshold=0.50, TEST_INPUT_SIZE=INPUT_RESOLUTION)